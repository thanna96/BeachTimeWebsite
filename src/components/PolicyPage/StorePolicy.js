    ...
    render() {
        return (
            <div>
                ...
                <h3>Return Policy</h3>
                <br/>
                <p className="row col-10 text-muted mx-auto col-md-6 container-fluid text-center">
                Unfortunately, Beach Time does not accept returns as we work
                on a made to order service. Returns will only be accepted if
                you have received a damaged item. However, all returns must be
                made within 10 days of receiving the product. Beach Time will not
                ...
                sizing or any other matter can be sent to beachtime@gmail.com.
